                ...
                return allTabs.map((section) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {section !== 'event_journal' && section !== 'lender' && !isComplete && hasRequiredFields && (
                        <Badge variant="destructive" className="h-5 min-w-[20px] px-1.5 text-xs font-medium">
                          {sectionMissing}
                        </Badge>
                      )}

                      {section !== 'event_journal' && section !== 'lender' && isComplete && hasRequiredFields && <CheckCircle2 className="h-4 w-4 text-success" />}
                    </TabsTrigger>
                  );
                });
              })()}
