...
export const WorkspaceTabBar: React.FC<WorkspaceTabBarProps> = ({ onRequestClose }) => {
  ...
  return (
    <div
      className="fixed top-12 right-0 left-64 z-30 h-10 border-b border-border bg-background overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent"
    >
