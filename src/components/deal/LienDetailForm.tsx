        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-3">
          ...
          <DirtyFieldWrapper fieldKey={DIRTY_KEY_MAP.interestRate}>
            <div className="flex items-center gap-3">
              ...
              <div className="relative flex-1">
                <Input value={lien.interestRate} onChange={(e) => onChange('interestRate', e.target.value)} disabled={disabled || isThisLoan} className={`h-7 text-sm text-right pr-6 ${isThisLoan ? 'opacity-50 bg-muted cursor-not-allowed' : ''}`} inputMode="decimal" placeholder="0.000" />
