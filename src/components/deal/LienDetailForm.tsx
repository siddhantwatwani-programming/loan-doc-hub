    ...
    <div className="p-4 space-y-4">
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2">
          ...
          <DirtyFieldWrapper fieldKey={DIRTY_KEY_MAP.loanType}>
            <div className="flex items-center gap-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-2 mt-2">
          ...
          <DirtyFieldWrapper fieldKey={DIRTY_KEY_MAP.existingRemain}>
            <div className="flex items-center gap-2">
          ...
          <div>
            <DirtyFieldWrapper fieldKey={DIRTY_KEY_MAP.existingPaydown}>
              <div className="flex items-center gap-2">
          ...
          <div>
            <DirtyFieldWrapper fieldKey={DIRTY_KEY_MAP.existingPayoff}>
              <div className="flex items-center gap-2">
